...
**Relevant modules:**
- **[Cobol initializer](../cobol-documenter/README.md)**: Essential for both greenfield and retrofit scenarios - assesses project architecture and generates initial AI context documentation and tool configurations **for the codebase you'll be actively developing with AI assistance**
